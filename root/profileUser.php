...
<body>
    ...
    <div class="profile_user">
        <div class ="left">
            ...
            <p class = "info1">Дата<br>рождения:</p> <p class="info2"><br><?= $_SESSION['user']['date_of_birth']?></p>
        </div>
        
        <div class ="right">
            <button class="btn_link_profile" id="btn_profile_history" onclick="ProfileInfo(`<?php echo $_SESSION['user']['login']?>`)">Изменить данные профиля</button>
